...
def run_Model_Selection(pipeline):
  ...
  for model_name in model_list:
    ...
    pipeline['Model_Selection']['NESTED_CV'][model_name]= {
                                                            'HP_tuning_df': None,
  ...
  # #inner loop Cross_validation AE
  # Model_CV_AE = get_Model_Selection_Error(pipeline=pipeline,
  #                                     loop= 'CV')
  
  # #Outerloop test AE
  # Model_test_AE = get_Model_Selection_Error(pipeline=pipeline,
  #                                     loop='test')
  # CV_MAE = Model_CV_AE.mean(axis = 0)
  # test_MAE = Model_test_AE.mean(axis = 0)
