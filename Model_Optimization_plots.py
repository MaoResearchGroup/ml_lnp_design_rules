...
def plot_AE_Box(cell_type_names, model_path, save_path):
    for cell in cell_type_names:
        ...
        plt.savefig(save_path + f"{cell} Model Selection Boxplot_wt.png", dpi=600, format = 'png', transparent=True, bbox_inches='tight')

        #plt.show()

def main():
    ################ Retreive/Store Data ##############################################
    model_path = 'Trained_Models/Models_Size_Zeta_comp/'
    save_path = "Figures/Model_Selection/Size_Zeta_comp/"
