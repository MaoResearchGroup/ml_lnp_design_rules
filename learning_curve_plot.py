...
"""**MAIN**"""
def main(model_list, cell_type_list, data_file_path, save_path, model_folder,input_param_names, size_cutoff, PDI_cutoff, prefix, NUM_ITER = 10):
    ################### MODEL TRAINING AND EVALUATION ##############
    for c in cell_type_list:
        #Get Training Data for cell type
        X, Y, _ = extract_training_data(data_file_path, input_param_names, c, size_cutoff, PDI_cutoff, prefix)
